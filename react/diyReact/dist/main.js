...
$export($export.S + $export.F * !__webpack_require__(8), 'Object', {
  defineProperties: __webpack_require__(88)
});
...
$export($export.S, 'Math', {
  fround: __webpack_require__(163)
});
...
var toISOString = __webpack_require__(198); // PhantomJS / old WebKit has a broken implementations
...
$export($export.P, 'Array', {
  copyWithin: __webpack_require__(102)
});
...
var regExpExec = __webpack_require__(52); // @@match logic
...
var regExpExec = __webpack_require__(52); // @@search logic
...
var $WeakMap = module.exports = __webpack_require__(56)(WEAK_MAP, wrapper, methods, weak, true, true); // IE11 WeakMap frozen keys fix
...
var userAgent = __webpack_require__(55); // https://github.com/zloirock/core-js/issues/280
...
function (_DiyReact$Component) {
  ...
  _createClass(App, [{
    ...
    value: function render() {
      return DiyReact.createElement("div", null, DiyReact.createElement("h1", null, "DiyReact Stories"), DiyReact.createElement("ul", null, this.props.stories.map(function (story) {
...
function (_DiyReact$Component2) {
  ...
  _createClass(Story, [{
    ...
    value: function render() {
      ...
      }, likes, DiyReact.createElement("b", null, "\u2764\uFE0F")), DiyReact.createElement("a", {
        href: url
      }, name));
